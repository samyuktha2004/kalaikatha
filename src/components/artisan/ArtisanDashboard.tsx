...
import { Mic, Upload, Image, Video, TrendingUp, Eye, ShoppingBag, Settings, Camera, MessageSquare, Lock, Store, Globe, Award } from 'lucide-react';
import { useState } from 'react';

interface ArtisanDashboardProps {
  onNavigate: (view: 'dashboard' | 'studio' | 'bargain' | 'marketing' | 'shop' | 'vault' | 'orders' | 'schemes') => void;
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 2, repeat: Infinity }}
            className="absolute top-4 right-4 px-3 py-1 bg-yellow-400 text-green-900 rounded-full text-xs font-bold"
          >
            NEW ✨
          </motion.div>
