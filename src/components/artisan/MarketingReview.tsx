...
export function MarketingReview({ onBack }: MarketingReviewProps) {
  ...
  const marketingContent = {
    instagram: {
      ...
      description: 'The Sacred Dance: A Hand-Chiselled Heritage Piece from the Heart of Thanjavur.\n\nUnlike hollow machine-molds, this piece is a Solid Lost-Wax Cast, carrying a unique weight of 4.2kg, with over nine generations of craftsmanship history.\n\nThis is a 12-inch Nataraja, made using the traditional lost-wax method passed down from my grandfather. It took 10 days of intensive hand-chisel work.\n\n#BronzeArt #Nataraja #ThanjavurBronze #LostWaxCasting #IndianHeritageCrafts #SacredArt #TempleBronze #HandmadeInIndia #SupportArtisans #TamilNaduCrafts',
      hashtags: ['#BronzeArt', '#Nataraja', '#ThanjavurBronze', '#LostWaxCasting', '#IndianHeritageCrafts', '#SacredArt', '#TempleBronze', '#HandmadeInIndia'],
      image: 'https://images.unsplash.com/photo-1582719366074-e33fe5f7ec73?w=800',
    },
    amazon: {
      title: 'Hand-Chiselled Bronze Nataraja Statue (12") - Solid Lost-Wax Cast | Thanjavur Heritage',
      description: 'Authentic Thanjavur bronze sculpture crafted by 9th generation master artisan. Unlike hollow machine-molds, this is a SOLID LOST-WAX CAST weighing 4.2kg. Traditional hand-chisel work over 10 days. Premium golden patina finish. Perfect for temple worship, meditation spaces, or luxury home decor. GI Tagged heritage craft from Tamil Nadu. Free shipping. Certificate of authenticity included.',
                    ...
                    navigator.clipboard.writeText(content).then(() => {
                      alert('📋 Copied to clipboard!\\n\\nYou can now paste this into ' + 
                        (selectedPlatform === 'instagram' ? 'Instagram' : 
                         selectedPlatform === 'amazon' ? 'Amazon Seller Central' : 'Etsy'));
