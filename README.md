# Kalaikatha - Artisan-to-Customer AI Ecosystem | Modern dual-UI platform connecting Indian heritage artisans with customers

Using an AI-powered ecosystem, we created Kalaikatha, a responsive web application featuring an interactive map for customer craft discovery, multilingual, voice-first artisan dashboard, and AI-powered price negotiation, accessibility features, and mobile-optimized design.
