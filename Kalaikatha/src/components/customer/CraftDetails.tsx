      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <button
              onClick={onClose}
              className="fixed top-6 right-6 p-3 rounded-full bg-white/90 backdrop-blur-sm hover:bg-white transition-colors z-50 shadow-lg"
            >
                  ...
                  {isAuthenticated ? (
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-8 text-center border border-indigo-100 dark:border-indigo-800">
                      ...
                      <button
                        ...
                        className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all"
                      >
                        Sign In / Sign Up
                      </button>
                    </div>
